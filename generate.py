...
DLW_DOCUMENTS_FIELDS = [
        ...
        ("Author (use | to separate authors)", "author", "varchar", 200),
        ("Publisher", "publisher", "varchar", 200),
        ("Affected donors (use | to separate donors)", "affected_donors", "varchar", 200),
        ("Affected donees (use | to separate donees)", "affected_donees", "varchar", 200),
